globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createError, getQuery, readBody, getCookie, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/@prisma/client/index.js';
import { defineNuxtConfig } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/nuxt/config.mjs';
import { SitemapStream, streamToPromise } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/sitemap/dist/index.js';
import { createRenderer } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { parseURL, withoutBase, joinURL, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/ufo/dist/index.mjs';
import destr from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/destr/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/hookable/dist/index.mjs';
import { hash } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/radix3/dist/index.mjs';
import cache from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/memory-cache/index.js';
import { performance } from 'perf_hooks';
import { FilterXSS } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/xss/lib/index.js';
import { defineCorsEventHandler } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/@nozomuikuta/h3-cors/dist/index.mjs';
import { MeiliSearch } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/meilisearch/dist/bundles/meilisearch.cjs.js';
import { extname, join } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/pathe/dist/index.mjs';
import { unified } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unified/index.js';
import { toString } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/remark-parse/index.js';
import remark2rehype from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/remark-rehype/index.js';
import { all } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/detab/index.js';
import { u } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unist-builder/index.js';
import { encode } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/mdurl/index.js';
import slugify from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/slugify/slugify.js';
import { position } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unist-util-position/index.js';
import htmlTags from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/html-tags/index.js';
import { visit } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/unenv/runtime/npm/consola.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/sehilton/Documents/github/meeovi-learning/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"C:\\Users\\sehilton\\Documents\\github\\meeovi-learning\\content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\sehilton\\Documents\\github\\meeovi-learning\\.nuxt\\content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\sehilton\\Documents\\github\\meeovi-learning","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\sehilton\\Documents\\github\\meeovi-learning\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\sehilton\\Documents\\github\\meeovi-learning\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\sehilton\\Documents\\github\\meeovi-learning\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Uj7phVPZHE = (function(nitro) {
...
let prisma$3;
const _7p8S9E = eventHandler((event) => {
  if (!prisma$3) {
...
const _i0nAeB = defineEventHandler(async (event) => {
...
const _D4EI2q = defineEventHandler(async (event) => {
...
const _UV16Bg = defineEventHandler(async (event) => {
...
const _3rAhLS = defineEventHandler(defineCorsEventHandler(securityConfig.corsHandler.value));

const useConfig = () => useRuntimeConfig().serverMeilisearchClient;

const _Hccp2p = defineEventHandler(async (event) => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://C:/Users/sehilton/Documents/github/meeovi-learning/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _Xox48e = defineEventHandler(async (event) => {
...
const _un8bIa = defineEventHandler(async (event) => {
...
const _E41Suh = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_sJqnGF = () => Promise.resolve().then(function () { return wishlists$1; });
const _lazy_MZjry0 = () => Promise.resolve().then(function () { return warehouses$1; });
const _lazy_D4Wemx = () => Promise.resolve().then(function () { return vendors$1; });
const _lazy_n7tr6N = () => Promise.resolve().then(function () { return users$1; });
const _lazy_q9giAh = () => Promise.resolve().then(function () { return update$1; });
const _lazy_UOgewc = () => Promise.resolve().then(function () { return transactions$1; });
const _lazy_zfV6xP = () => Promise.resolve().then(function () { return templates$1; });
const _lazy_7kDqfM = () => Promise.resolve().then(function () { return taxes$1; });
const _lazy_3VoKpo = () => Promise.resolve().then(function () { return tags$1; });
const _lazy_nbISD8 = () => Promise.resolve().then(function () { return states$1; });
const _lazy_uryI2R = () => Promise.resolve().then(function () { return shipments$1; });
const _lazy_lJyszm = () => Promise.resolve().then(function () { return settings$1; });
const _lazy_5bbdcl = () => Promise.resolve().then(function () { return serverSessions$1; });
const _lazy_OqyZzJ = () => Promise.resolve().then(function () { return sales$1; });
const _lazy_sOuIhO = () => Promise.resolve().then(function () { return roles$1; });
const _lazy_t0eP7b = () => Promise.resolve().then(function () { return reviews$1; });
const _lazy_3Yhr60 = () => Promise.resolve().then(function () { return read$1; });
const _lazy_mm3jYl = () => Promise.resolve().then(function () { return quotes$1; });
const _lazy_xOVQiu = () => Promise.resolve().then(function () { return providers$1; });
const _lazy_iVNRSO = () => Promise.resolve().then(function () { return productTypes$1; });
const _lazy_vNdGbZ = () => Promise.resolve().then(function () { return products$1; });
const _lazy_KsWVAb = () => Promise.resolve().then(function () { return prisma$2; });
const _lazy_oopL38 = () => Promise.resolve().then(function () { return permissions$1; });
const _lazy_HLSngX = () => Promise.resolve().then(function () { return payments$1; });
const _lazy_7EmpCh = () => Promise.resolve().then(function () { return partners$1; });
const _lazy_PxbADE = () => Promise.resolve().then(function () { return pagination; });
const _lazy_m5lJGs = () => Promise.resolve().then(function () { return pages$1; });
const _lazy_uPyOJA = () => Promise.resolve().then(function () { return newsletters$1; });
const _lazy_pazss8 = () => Promise.resolve().then(function () { return middleware; });
const _lazy_1IWVff = () => Promise.resolve().then(function () { return metrics$1; });
const _lazy_S4isei = () => Promise.resolve().then(function () { return manufacturers$1; });
const _lazy_EDzl8n = () => Promise.resolve().then(function () { return logging; });
const _lazy_MIrhnb = () => Promise.resolve().then(function () { return invoices$1; });
const _lazy_IoeMfa = () => Promise.resolve().then(function () { return integrations$1; });
const _lazy_qDfp2X = () => Promise.resolve().then(function () { return filterSort; });
const _lazy_lpEHbP = () => Promise.resolve().then(function () { return errors; });
const _lazy_GRlfZf = () => Promise.resolve().then(function () { return emails$1; });
const _lazy_pYZDMC = () => Promise.resolve().then(function () { return discounts$1; });
const _lazy_I61hNM = () => Promise.resolve().then(function () { return _delete$1; });
const _lazy_4flk6C = () => Promise.resolve().then(function () { return dashboards$1; });
const _lazy_O999VF = () => Promise.resolve().then(function () { return customers$1; });
const _lazy_jsxmdF = () => Promise.resolve().then(function () { return currencies$1; });
const _lazy_4PyLsB = () => Promise.resolve().then(function () { return create$1; });
const _lazy_XjdetR = () => Promise.resolve().then(function () { return countries$1; });
const _lazy_2j44ee = () => Promise.resolve().then(function () { return collections$1; });
const _lazy_JsGqBd = () => Promise.resolve().then(function () { return cities; });
const _lazy_JXelL6 = () => Promise.resolve().then(function () { return channels$1; });
const _lazy_idYjWE = () => Promise.resolve().then(function () { return categories$1; });
const _lazy_sEOvWF = () => Promise.resolve().then(function () { return brands$1; });
const _lazy_YIGPqC = () => Promise.resolve().then(function () { return blog$1; });
const _lazy_i0Kios = () => Promise.resolve().then(function () { return _____; });
const _lazy_0AMmEo = () => Promise.resolve().then(function () { return attributes$1; });
const _lazy_uHn1ut = () => Promise.resolve().then(function () { return agreements$1; });
const _lazy_GelQt7 = () => Promise.resolve().then(function () { return sitemap_xml$1; });
const _lazy_fvt1R8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _7p8S9E, lazy: false, middleware: true, method: undefined },
  { route: '/api/wishlists', handler: _lazy_sJqnGF, lazy: true, middleware: false, method: undefined },
  { route: '/api/warehouses', handler: _lazy_MZjry0, lazy: true, middleware: false, method: undefined },
  { route: '/api/vendors', handler: _lazy_D4Wemx, lazy: true, middleware: false, method: undefined },
  { route: '/api/users', handler: _lazy_n7tr6N, lazy: true, middleware: false, method: undefined },
  { route: '/api/update', handler: _lazy_q9giAh, lazy: true, middleware: false, method: undefined },
  { route: '/api/transactions', handler: _lazy_UOgewc, lazy: true, middleware: false, method: undefined },
  { route: '/api/templates', handler: _lazy_zfV6xP, lazy: true, middleware: false, method: undefined },
  { route: '/api/taxes', handler: _lazy_7kDqfM, lazy: true, middleware: false, method: undefined },
  { route: '/api/tags', handler: _lazy_3VoKpo, lazy: true, middleware: false, method: undefined },
  { route: '/api/states', handler: _lazy_nbISD8, lazy: true, middleware: false, method: undefined },
  { route: '/api/shipments', handler: _lazy_uryI2R, lazy: true, middleware: false, method: undefined },
  { route: '/api/settings', handler: _lazy_lJyszm, lazy: true, middleware: false, method: undefined },
  { route: '/api/serverSessions', handler: _lazy_5bbdcl, lazy: true, middleware: false, method: undefined },
  { route: '/api/sales', handler: _lazy_OqyZzJ, lazy: true, middleware: false, method: undefined },
  { route: '/api/roles', handler: _lazy_sOuIhO, lazy: true, middleware: false, method: undefined },
  { route: '/api/reviews', handler: _lazy_t0eP7b, lazy: true, middleware: false, method: undefined },
  { route: '/api/read', handler: _lazy_3Yhr60, lazy: true, middleware: false, method: undefined },
  { route: '/api/quotes', handler: _lazy_mm3jYl, lazy: true, middleware: false, method: undefined },
  { route: '/api/providers', handler: _lazy_xOVQiu, lazy: true, middleware: false, method: undefined },
  { route: '/api/productTypes', handler: _lazy_iVNRSO, lazy: true, middleware: false, method: undefined },
  { route: '/api/products', handler: _lazy_vNdGbZ, lazy: true, middleware: false, method: undefined },
  { route: '/api/prisma', handler: _lazy_KsWVAb, lazy: true, middleware: false, method: undefined },
  { route: '/api/permissions', handler: _lazy_oopL38, lazy: true, middleware: false, method: undefined },
  { route: '/api/payments', handler: _lazy_HLSngX, lazy: true, middleware: false, method: undefined },
  { route: '/api/partners', handler: _lazy_7EmpCh, lazy: true, middleware: false, method: undefined },
  { route: '/api/pagination', handler: _lazy_PxbADE, lazy: true, middleware: false, method: undefined },
  { route: '/api/pages', handler: _lazy_m5lJGs, lazy: true, middleware: false, method: undefined },
  { route: '/api/newsletters', handler: _lazy_uPyOJA, lazy: true, middleware: false, method: undefined },
  { route: '/api/middleware', handler: _lazy_pazss8, lazy: true, middleware: false, method: undefined },
  { route: '/api/metrics', handler: _lazy_1IWVff, lazy: true, middleware: false, method: undefined },
  { route: '/api/manufacturers', handler: _lazy_S4isei, lazy: true, middleware: false, method: undefined },
  { route: '/api/logging', handler: _lazy_EDzl8n, lazy: true, middleware: false, method: undefined },
  { route: '/api/invoices', handler: _lazy_MIrhnb, lazy: true, middleware: false, method: undefined },
  { route: '/api/integrations', handler: _lazy_IoeMfa, lazy: true, middleware: false, method: undefined },
  { route: '/api/filterSort', handler: _lazy_qDfp2X, lazy: true, middleware: false, method: undefined },
  { route: '/api/errors', handler: _lazy_lpEHbP, lazy: true, middleware: false, method: undefined },
  { route: '/api/emails', handler: _lazy_GRlfZf, lazy: true, middleware: false, method: undefined },
  { route: '/api/discounts', handler: _lazy_pYZDMC, lazy: true, middleware: false, method: undefined },
  { route: '/api/delete', handler: _lazy_I61hNM, lazy: true, middleware: false, method: undefined },
  { route: '/api/dashboards', handler: _lazy_4flk6C, lazy: true, middleware: false, method: undefined },
  { route: '/api/customers', handler: _lazy_O999VF, lazy: true, middleware: false, method: undefined },
  { route: '/api/currencies', handler: _lazy_jsxmdF, lazy: true, middleware: false, method: undefined },
  { route: '/api/create', handler: _lazy_4PyLsB, lazy: true, middleware: false, method: undefined },
  { route: '/api/countries', handler: _lazy_XjdetR, lazy: true, middleware: false, method: undefined },
  { route: '/api/collections', handler: _lazy_2j44ee, lazy: true, middleware: false, method: undefined },
  { route: '/api/cities', handler: _lazy_JsGqBd, lazy: true, middleware: false, method: undefined },
  { route: '/api/channels', handler: _lazy_JXelL6, lazy: true, middleware: false, method: undefined },
  { route: '/api/categories', handler: _lazy_idYjWE, lazy: true, middleware: false, method: undefined },
  { route: '/api/brands', handler: _lazy_sEOvWF, lazy: true, middleware: false, method: undefined },
  { route: '/api/blog', handler: _lazy_YIGPqC, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/**', handler: _lazy_i0Kios, lazy: true, middleware: false, method: undefined },
  { route: '/api/attributes', handler: _lazy_0AMmEo, lazy: true, middleware: false, method: undefined },
  { route: '/api/agreements', handler: _lazy_uHn1ut, lazy: true, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _lazy_GelQt7, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_fvt1R8, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _i0nAeB, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _D4EI2q, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _UV16Bg, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _3rAhLS, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Hccp2p, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _Xox48e, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _Xox48e, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _Xox48e, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _un8bIa, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _E41Suh, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _E41Suh, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _E41Suh, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_fvt1R8, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/sehilton/Documents/github/meeovi-learning/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
